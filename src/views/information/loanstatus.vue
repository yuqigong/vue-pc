        ...
        <el-row>
            <el-form :inline="true" ref="searchDate" :model="searchDate" label-width="110px">
                ...
                <el-form-item
                    ...
                    prop="loan_status"
                >
                    <el-select v-model="searchDate.loan_status" placeholder="请选择">
                        <el-option
...
<script lang="babel">
    import {getLoanStatusList} from '../../api/information'
    ...
    export default {
        ...
        methods: {
            queryLoanStatusList (params) {

                params = params ? params : {};

                getLoanStatusList(params).then(response => {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.queryLoanStatusList({
                            ...
                            loan_status: this.searchDate.loan_status,
                            page_no: this.paging.currentPage,
                            page_size: this.paging.pageSize
                        })
                    } else {
